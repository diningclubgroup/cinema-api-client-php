...
/**
 * OrdersTickets Class Doc Comment
 *
 * @category    Class
 * @package     DCG\Cinema
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class OrdersTickets implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'orders_tickets';
    ...
    /**
     * Sets ticket_type_id
     * @param string $ticket_type_id The ID of the ticket type
     * @return $this
     */
    ...
    /**
     * Sets quantity
     * @param float $quantity The number of tickets to be purchased of the associated ticket type ID
     * @return $this
     */
